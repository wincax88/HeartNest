...
export const companions: Companion[] = [
  {
    ...
    traits: ['温柔治愈', '情绪接纳', '夜间陪伴'], avatar: '/static/heartnest/avatar-mika.webp',
    cardImage: '/static/heartnest/mika-card.webp', profileImage: '/static/heartnest/mika-profile.webp',
  ...
  },
  {
    ...
    traits: ['耐心倾听', '温暖陪伴', '低压回应'], avatar: '/static/heartnest/avatar-luna.webp',
    cardImage: '/static/heartnest/luna-card.webp', profileImage: '/static/heartnest/luna-card.webp',
  ...
  },
  {
    ...
    traits: ['理性分析', '成长支持', '行动梳理'], avatar: '/static/heartnest/avatar-aiden.webp',
    cardImage: '/static/heartnest/aiden-card.webp', profileImage: '/static/heartnest/aiden-card.webp',
